<template>    
    <div class="container">
        <h1><span>const </span>Qui suis-je ?<span>=</span></h1>
        <p>
            ...
            j'ai donc décidé de reprendre mes études. Ayant toujours été plutôt à l'aise avec l'outil informatique ,j'ai décidé passer ma formation de 
